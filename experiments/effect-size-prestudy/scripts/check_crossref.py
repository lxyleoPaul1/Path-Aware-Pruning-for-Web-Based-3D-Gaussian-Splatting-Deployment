...
def main() -> None:
    ...
    parser.add_argument("--ts", type=Path, required=True, help="Path to crossref-ts-output.txt")
    parser.add_argument("--py", type=Path, required=True, help="Path to crossref-py-output.txt")
    parser.add_argument("--ts-scores", type=Path, required=True, help="Path to crossref-ts-scores.json")
    parser.add_argument("--py-scores", type=Path, required=True, help="Path to crossref-py-scores.json")
